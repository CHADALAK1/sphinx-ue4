...
private:
	...
	USpeechRecognitionActor* Manager;
...
public:
	...
	bool EnableLanguageModel(FString _languageModel);
	...
	bool StartThread(USpeechRecognitionActor* manager);
	void ShutDown();
